    ...
    <div>
         <div class="row">
             ...
             <div class="col-md-8">
                 <div class="card">
                     <div class="card-body">
                         <h3 style="text-align:center;text-decoration:underline">Edit Product  <router-link to="color_manage" style="float:right" class="btn btn-success btn-sm">Manage Product</router-link></h3>
                            ...
                            <div class="col-md-12">
                             ...
                             <div class="row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <img style="width:200px" :src="'http://127.0.0.1:8000/upload/product/'+form.image" alt="">
                                </div>
                            </div>


                            <div class="row">
                               <label for="">Old Gallery Image</label>
                                <div class="col-md-3" v-for="(ViewGallery,index) in ViewGallerys" :key="ViewGallery.id">
                                    
                                    <img style="width:200px" :src="'http://127.0.0.1:8000/upload/product_gallery/'+ViewGallery.gallery"  alt="">
                                </div>
                            </div>
                              ...
                              <div class="col-md-12">
                                ...
                                <input type="file" class="form-control" multiple name="gallery" @change="Updatemultigallery" placeholder="enter color name">
...
export default {
    ...
    methods: {
        ...
        UpdateProduct(){
            this.form.post('/admin/product-update')
            .then((result) => {
          ...
          EditData(){
              ...
              .then((result) => {
                  ...
                  this.ViewGallerys = result.data['gall'];
